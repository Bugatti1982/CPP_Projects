...
; File C:\Users\welch\Desktop\Important Programming Projects\C Plus Plus\Projects\HelloWorld\HelloWorld\Log.cpp
; Line 5
$LN3:
	mov	QWORD PTR [rsp+8], rcx
	push	rbp
	...
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__6305F584_Log@cpp
	call	__CheckForDebuggerJustMyCode
; Line 6
